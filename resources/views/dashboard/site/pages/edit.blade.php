...
@section('content')
    <div class="container-fluid px-5 py-3">
        <x-breadcrumb.breadcrumb title="{{ __('dashboard.Pages') }}" :breadcrumbs="[['name' => __('dashboard.Pages'), 'route' => 'pages.index'], ['name' => __('dashboard.Edit')]]" />

        <x-cards.page-card>
            <x-slot name="header">
                <div class="card-title">
                    @lang('dashboard.Edit') @lang('dashboard.Page')
                </div>
            </x-slot>
            <x-form.form-component :route="route('pages.update', $page->id)" method="PUT">
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="description_en" class="form-label">{{ __('dashboard.Description (English)') }}
                                <span class="text-danger">*</span></label>
                            <textarea class="form-control" name="description_en" id="description_en" rows="5"
                                placeholder="{{ __('dashboard.Enter page description in English') }}" required>{{ $page->description_en }}</textarea>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="description_ar" id="description_ar" rows="5"
                                placeholder="{{ __('dashboard.Enter page description in Arabic') }}" required>{{ $page->description_ar }}</textarea>
