...
@section('content')
    <div class="container-fluid">
        ...
        <h1 class="page-title fw-semibold fs-18 mb-0">Romiooooooooooooooooooooooooooooooooo</h1>
        ...
        <x-breadcrumb title="Users" :breadcrumbs="[['name' => 'Users', 'route' => 'users.index'], ['name' => 'Users']]" />
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-8 ps-0">
                                        ...
                                        <div>
                                            <span class="fs-12 mb-0">Increase by <span
                                                    class="badge bg-success-transparent text-success mx-1">+12.0%</span>
                                                this month</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card custom-card overflow-hidden">
                            <div class="ecommerce-sale-image">
                                ...
                                <div class="card-img-overlay d-flex flex-column p-4 text-fixed-white">
                                    ...
                                    <p class="ecommerce-bankoffer-details">Bank Offer 10% off on Aches Bank Credit Cards,
                                        up to $10. On orders of $500 and above <a href="javascript:void(0);"
                            ...
                            <div class="card-body">
                                <a href="#" class="text-primary fs-15 fw-semibold">Biggest sale is back.</a>
                                <p class="mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Labore harum
                                    accusamus eum dolorum sapiente. Saepe</p>
                                    ...
                                    <ul class="nav nav-tabs justify-content-end nav-tabs-header mb-0 d-sm-flex d-block mt-sm-0 mt-2"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" data-bs-toggle="tab" role="tab"
                                                aria-current="page" href="#active-orders" aria-selected="true">Active
                                                Orders</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" role="tab" aria-current="page"
                                                href="#completed-orders" aria-selected="true">Completed</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" role="tab" aria-current="page"
                                                href="#cancelled-orders" aria-selected="true">Cancelled</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                            ...
                                            <table class="table card-table table-vcenter text-nowrap mb-0">
                                                <tbody class="active-tab">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img src="../assets/images/ecommerce/png/1.png"
                                                                    alt="">
                                                            </span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img src="../assets/images/ecommerce/png/2.png"
                                                                    alt="">
                                                            </span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img src="../assets/images/ecommerce/png/3.png"
                                                                    alt="">
                                                            </span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img src="../assets/images/ecommerce/png/4.png"
                                                                    alt="">
                                                            </span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img src="../assets/images/ecommerce/png/5.png"
                                                                    alt="">
                                                            </span>
                                                        </td>
                                                        <td>
                                            ...
                                            <table class="table card-table table-vcenter text-nowrap mb-0">
                                                <tbody class="active-tab">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img src="../assets/images/ecommerce/png/6.png"
                                                                    alt="">
                                                            </span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img src="../assets/images/ecommerce/png/7.png"
                                                                    alt="">
                                                            </span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img src="../assets/images/ecommerce/png/8.png"
                                                                    alt="">
                                                            </span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img src="../assets/images/ecommerce/png/9.png"
                                                                    alt="">
                                                            </span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img src="../assets/images/ecommerce/png/10.png"
                                                                    alt="">
                                                            </span>
                                                        </td>
                                                        <td>
                                            ...
                                            <table class="table card-table table-vcenter text-nowrap mb-0">
                                                <tbody class="active-tab">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img src="../assets/images/ecommerce/png/11.png"
                                                                    alt="">
                                                            </span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img src="../assets/images/ecommerce/png/12.png"
                                                                    alt="">
                                                            </span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img src="../assets/images/ecommerce/png/13.png"
                                                                    alt="">
                                                            </span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img src="../assets/images/ecommerce/png/14.png"
                                                                    alt="">
                                                            </span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img src="../assets/images/ecommerce/png/15.png"
                                                                    alt="">
                                                            </span>
                                                        </td>
                                                        <td>
                        ...
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div><span class="badge bg-primary-transparent mx-1">12.24%</span><span
                                            class="text-muted fs-11">Since last week</span></div>
                                </div>
